(function (d) {
    var m = {
        ...
        startPaused: !1
            ...
            animate: function (a, b, e) {
                var c = a.itemHeight,
                    f = a.options,
                    g = a.element.children("ul"),
                    k = "up" === e ? "li:first" : "li:last",
                    l = g.children(k).clone(!0);
                0 < f.height && (c = g.children("li:first").height());
                c += f.margin + 2 * f.padding;
                "down" === e && g.css("top", "-" + c + "px").prepend(l);
                if (b && b.animate) {
                    ...
                    g.animate("up" === e ? {
                        ...
                        d(g).children(k).remove();
                        d(g).css("top", "0px");
                        a.animating = !1
                    })
                } else g.children(k).remove(), g.css("top", "0px");
                "up" === e && l.appendTo(g)
            },
            ...
            pause: function (a) {
                ...
                if (b) {
                    ...
                    (b.isPaused = a) ? d(this).addClass("paused") : d(this).removeClass("paused")
                }
            },
            next: function (a) {
                var b = d(this).data("state");
    ...
    d.fn.vTicker = function (a) {
        ...
        if ("object" !== typeof a && a) d.error("Method " + a + " does not exist on jQuery.");
