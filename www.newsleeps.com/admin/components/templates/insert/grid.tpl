...
<div align="center" style="width: 100%">
    <form name="insertform" enctype="multipart/form-data" method="POST" action="{$Grid->GetEditPageAction()}">
...
{/foreach}
            ...
            <tr height="40" class="editor_buttons"><td colspan="4" align="center" valign="top">
                <input class="sm_button" type="button" value="{$Captions->GetMessageString('SaveNewRecord')}" name="submit1" onclick="if (ValidateControls()) document.insertform.submit();"/>
